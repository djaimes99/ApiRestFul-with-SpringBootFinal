...
public class MakeController {
    ...
    public ResponseEntity<?> findById(@PathVariable Long id) {
        ...
        return ResponseEntity.notFound().build();// Si no encuentra nada vuelve vacío
    }
    ...
    public ResponseEntity<?> findAll() {
        ...
        List<MakerDTO> makerList = makerService.findAll()
                ...
                .map(maker -> MakerDTO.builder()
                        ...
                        .build())
                .toList();
        /*Hasta aqui ya hemos transforamdo nuestro Maker de entities a DTO que es lo que se necesita*/
        return ResponseEntity.ok(makerList);//acá solo lo retornamos y listo!!
    }
